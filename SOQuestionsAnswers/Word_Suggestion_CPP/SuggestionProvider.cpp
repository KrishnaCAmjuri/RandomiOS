...
SuggestionProvider::SuggestionProvider(const std::string &dictPath, const std::vector<std::string> &proximityPathVec) {
    
    // Create a new proximity provider
    proximityProvider = new ProximityProvider(proximityPathVec);
